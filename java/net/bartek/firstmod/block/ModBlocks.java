package net.bartek.firstmod.block;

import net.bartek.firstmod.MyFirstMod;
import net.bartek.firstmod.block.custom.CornCropBlock;
import net.bartek.firstmod.block.custom.GemPolishingStationBlock;
import net.bartek.firstmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SOUND_BL0CK = registerBlock("sound_block",
