package net.bartek.firstmod.entities.custom;

import net.bartek.firstmod.entities.ModEntities;
import net.bartek.firstmod.entities.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    private void setUpAnimationStates(){
        ...
        if(this.isAttacking() && attackAnimationTimeout <= 0){
            attackAnimationTimeout = 80; // length of animation
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new RhinoAttackGoal(this, 1.0D, true));
