package net.bartek.firstmod.item;
...
public class ModCreativeModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> TUTORIAL_TAB = CREATIVE_MODE_TABS.register("myfirstmod_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.SAPPHIRE.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModBlocks.SOUND_BL0CK.get());
